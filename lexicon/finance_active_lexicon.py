from data_for_change.active_finance import (
    ...
    CERTIFICATE_LINK, GYOUNG_LINK, GSOCIAL_LINK, NPD_LINK, CRAFTS_LINK, SOON,
)

ACTIVE: dict[int, str] = {
    1:  f'{SOON}\n\n'
        '<b>Приобретение оборудования для развития производства</b>\n\n'
    ...
    3:  f'{SOON}\n\n'
        '<b>Компенсация затрат, связанных с лизингом</b>\n\n'
        '<b><i>Кто может получить:</i></b>\n'
    ...
    5:  f'{SOON}\n\n'
        '<b>Грант для предпринимателей до 25 лет включительно</b>\n\n'
       '<b><i>Кто может получить:</i></b>\n'
    ...
    6: f'{SOON}\n\n'
       '<b>Субсидия для народных художественных промыслов</b>\n\n'
       '<b><i>Кто может получить:</i></b>\n'
       'субъект МСП, осуществляющий деятельность в Ленинградской области;\n'
    ...
    7: f'{SOON}\n\n'
       '<b>Субсидия для участия в выставках и ярмарках</b>\n\n'
       '<b><i>Кто может получить:</i></b>\n'
       'субъект МСП, осуществляющий деятельность в Ленинградской области;\n'
       '<b><i>Размер субсидии:</i></b>\n'
       'не более 90% затрат\n'
    ...
    8: f'{SOON}\n\n'
       '<b>Субсидия для получения сертификатов</b>\n\n'
       '<b><i>Кто может получить:</i></b>\n'
       'субъект МСП, осуществляющий деятельность в Ленинградской области;\n'
       '<b><i>Размер субсидии:</i></b>\n'
       'не более 90% затрат\n'
    ...
    9: '<b>Субсидия для предпринимателей до 35 лет включительно</b>\n\n'
       '<b><i>Кто может получить:</i></b>\n'
       'субъект МСП, осуществляющий деятельность в Гатчинском районе;\n'
       'возраст предпринимателя до 35 лет включительно;\n'
       '<b><i>Размер субсидии:</i></b>\n'
       'до 100 тыс. руб., но не более 80% затрат\n'
       '<b><i>На что можно потратить:</i></b>\n'
       'аренда, покупка оборудования и мебели, оплата связи',
    10: '<b>Субсидия для социальных предпринимателей</b>\n\n'
       '<b><i>Кто может получить:</i></b>\n'
       'субъект МСП, осуществляющий деятельность в Гатчинском районе;\n'
       'наличие статуса социального предприятия;\n'
       '<b><i>Размер субсидии:</i></b>\n'
       'до 100 тыс. руб., но не более 80% затрат\n'
       '<b><i>На что можно потратить:</i></b>\n'
       'аренда, покупка оборудования и мебели, оплата связи',
    11: '<b>Субсидия для производителей народных и художественных'
        'промыслов</b>\n\n'
        '<b><i>Кто может получить:</i></b>\n'
        'субъект МСП, осуществляющий деятельность в Гатчинском районе;\n'
        'предприниматель - производитель народных и художественных'
        'промыслов;\n'
        '<b><i>Размер субсидии:</i></b>\n'
        'до 50 тыс. руб., но не более 80% затрат\n'
        '<b><i>На что можно потратить:</i></b>\n'
        'аренда, материалы, покупка оборудования и мебели, оплата связи',
    12: '<b>Субсидия для ИП на НПД (самозанятости)</b>\n\n'
        '<b><i>Кто может получить:</i></b>\n'
        'субъект МСП, осуществляющий деятельность в Гатчинском районе;\n'
        'ИП на НПД (самозанятости);\n'
        '<b><i>Размер субсидии:</i></b>\n'
        'до 100 тыс. руб., но не более 80% затрат\n'
        '<b><i>На что можно потратить:</i></b>\n'
        'аренда, покупка оборудования и мебели, оплата связи',
